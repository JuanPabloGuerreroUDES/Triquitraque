...
public class JuegoVista extends javax.swing.JFrame {
    ...
    //libreria de resultados posibles
    int victorias[][]={
        {1,2,3},
        {4,5,6},
        {7,8,9},
    ...
    //Metodo para recibir Jugadores
    public void SetJugadores(Jugador jugador1, Jugador jugador2){
        this.jugador1=jugador1;
        this.jugador2=jugador2;
        juego.setNombreTurno(jugador1.getNombre());
        lblTurno.setText(juego.getNombreTurno());
        nombrePrimerTurno=jugador1.getNombre();
        
        lblJugador1.setText(jugador1.getNombre()+": "+jugador1.getVictorias());
        lblJugador2.setText(jugador2.getNombre()+": "+jugador2.getVictorias());
    }
    ...
    private void initComponents() {
        ...
        lblGanadorTurno = new javax.swing.JLabel();
        lblGanadorTurno1 = new javax.swing.JLabel();
        lblGanadorTurno2 = new javax.swing.JLabel();
        ...
        JLabelTurno.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N
        JLabelTurno.setText("Turno de: ");

        lblJugador1.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N
        lblJugador1.setText("Jugador1:");

        lblJugador2.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N
        lblJugador2.setText("Jugador1:");

        btnReiniciar.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N
        ...
        btnMenu.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N
        ...
        lblTurno.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N

        lblGanadorTurno.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N

        lblGanadorTurno1.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N

        lblGanadorTurno2.setFont(new java.awt.Font("Eras Demi ITC", 0, 14)); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblGanadorTurno1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(23, 23, 23)
                                .addComponent(lblJugador2)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(lblGanadorTurno2, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                            ...
                            .addComponent(lblGanadorTurno, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lblGanadorTurno, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblGanadorTurno1, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblGanadorTurno2, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnReiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReiniciarActionPerformed
        ...
        if(primerTurno.equals("X")){
            primerTurno="O";
            nombrePrimerTurno=jugador2.getNombre();
        }else{
            primerTurno="X";
            nombrePrimerTurno=jugador1.getNombre();
            
        }
        juego.setNombreTurno(nombrePrimerTurno);
        juego.setTurno(primerTurno);
        juego.setEnJuego(true);
        
        lblGanadorTurno.setText("");
    ...
    public void presionar(int casilla){
        if(lbs[casilla-1].getText().equals("")){
            ...
            case "Verde":
                lbs[casilla-1].setForeground(Color.green);
                break;
                
            case "Amarillo":
                lbs[casilla-1].setForeground(Color.yellow);
                break;
                
            case "Negro":
                lbs[casilla-1].setForeground(Color.black);
                break;
        }
            }else{
            ...
            comprobar();
            juego.cambioNombreTurno(jugador1, jugador2);
            lblTurno.setText(juego.getNombreTurno());
        }
    }
    ...
    public void comprobar(){
        for (int i=0;i<victorias.length;i++){
            if(lbs[victorias[i][0]-1].getText().equals("X")&&
                ...
                lblGanadorTurno.setText("Ha ganado "+jugador1.getNombre());
                jugador1.victoria();
                lblJugador1.setText(jugador1.getNombre()+": "+jugador1.getVictorias());
            ...
            if(lbs[victorias[i][0]-1].getText().equals("O")&&
                ...
                lblGanadorTurno.setText("Ha ganado "+jugador2.getNombre());
                jugador2.victoria();
                lblJugador2.setText(jugador2.getNombre()+": "+jugador2.getVictorias());
    ...
    private javax.swing.JLabel lblGanadorTurno;
    private javax.swing.JLabel lblGanadorTurno1;
    private javax.swing.JLabel lblGanadorTurno2;
